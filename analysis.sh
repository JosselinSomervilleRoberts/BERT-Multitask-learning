...
# FINTETUNE - SURGERY
python3 multitask_classifier.py --num_batches_per_epoch 1800 --pretrained_model_name pretrain_1.pt --use_gpu --use_amp --epochs 10 --lr 1e-5 --batch_size 64 --option finetune --task_scheduler pal --hidden_dropout_prob 0.2  --projection pcgrad --patience 3 --n_hidden_layers 1 --max_batch_size_sst 32 --max_batch_size_para 16 --max_batch_size_sts 32 > finetune_1_surgery_logs.txt
#mv finetune-10-1e-05-multitask.pt finetune_1_surgery.pt

# FINTETUNE - VACCINE
python3 multitask_classifier.py --num_batches_per_epoch 1800 --pretrained_model_name pretrain_1.pt --use_gpu --use_amp --epochs 10 --lr 1e-5 --batch_size 64 --option finetune --task_scheduler pal --hidden_dropout_prob 0.2  --projection vaccine --patience 3 --n_hidden_layers 1 --max_batch_size_sst 32 --max_batch_size_para 16 --max_batch_size_sts 32 > finetune_1_vaccine_logs.txt
